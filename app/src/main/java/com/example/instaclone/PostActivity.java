...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CropImage.activity().start(PostActivity.this);
                    ...
                    //error resolved: https://www.youtube.com/watch?v=CQ5qcJetYAI   (Firebase console: storage -- rules-- ,, removed line after read,write
                    // todo:             ||   , used the progress bar,  showing real time upload % ,,
    private void upload() {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            imageUri = result.getUri();        // store  the imgURI   , which is used in upload()

            imageAdded.setImageURI(imageUri);           // to show the imageView when ,, after we select & crop the IMG,,,
        } else {
